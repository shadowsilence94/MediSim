...
\textbf{MediSim Fusion (Proposed)} & 51.08\% & 44.85\% & 51.08\% & 46.82\% & N/A \\
\midrule
Single-Agent (Triage Baseline) & - & - & - & - & App Target \\
\textbf{Multi-Agent (Proposed)} & - & - & - & - & App Target \\
\bottomrule
\end{tabular}
}
\caption{Performance comparison between baseline architectures and the proposed MediSim components.}
